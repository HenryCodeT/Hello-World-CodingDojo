...
print( "Hola, Mundo" ) #print console, string
# 2. imprime "Hola, Noelle" con el nombre en una variable
name = "Noelle" #variable declaration, string initialized
print( "Hola,",name,"!" )	# con una coma
print( "Hola, " + name +"!")	# con un +
# 3. imprimir "Hola 42!" con el número en una variable
name = 42 #variable declaration, number initialized
print( "Hola", name,"!" )	# con una coma
print( "Hola " +str(name)+"!")	# con una +	-- este debería arrojar un error!
#4. imprimir "Amo comer sushi y pizza" con las comidas en variables
fave_food1 = "sushi" # variable declaration, string initialized
fave_food2 = "pizza" # variable decalration, string initialized
